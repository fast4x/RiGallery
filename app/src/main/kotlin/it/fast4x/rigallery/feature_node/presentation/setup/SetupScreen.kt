...
import it.fast4x.rigallery.core.Settings.Misc.rememberIsMediaManager
import it.fast4x.rigallery.core.presentation.components.SetupWizard
...
import it.fast4x.rigallery.feature_node.presentation.util.RepeatOnResume
import it.fast4x.rigallery.feature_node.presentation.util.isManageFilesAllowed
import it.fast4x.rigallery.feature_node.presentation.util.launchManageFiles
import it.fast4x.rigallery.feature_node.presentation.util.launchManageMedia
...
fun SetupScreen(
    ...
    val appName = "${stringResource(id = R.string.app_name)} v${_root_ide_package_.it.fast4x.rigallery.BuildConfig.VERSION_NAME}"
