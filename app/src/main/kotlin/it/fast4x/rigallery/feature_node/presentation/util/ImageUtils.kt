...
import it.fast4x.rigallery.feature_node.presentation.mediaview.components.retrieveMetadata
...
fun Uri.authorizedUri(context: Context): Uri = if (this.toString()
    ...
    context,
    _root_ide_package_.it.fast4x.rigallery.BuildConfig.CONTENT_AUTHORITY,
    this.toFile()
)
